...
def plot_results(bpsk_summary, qpsk_summary):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(_OUT_FIG, 'e6_relay_comparison_symmetric.png'), dpi=150, bbox_inches='tight')
    print("\n  Saved: /tmp/e6_relay_comparison_symmetric.png")

    np.save(os.path.join(_OUT_NPY, 'e6_relay_comparison_symmetric_results.npy'),
