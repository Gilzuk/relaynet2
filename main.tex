...
%-------------------------------------
% reviewer mode :comment the two lines below for reviewing the thesis
...
% Final mode: comment the two lines above and use: 
% \newcommand{\AK}[1]{} 
% \newcommand{\REV}[1]{}
...
\listoftables
\AK{You need to use square-brackets to display more concise table and figure titles in the corresponding lists.}
\clearpage
