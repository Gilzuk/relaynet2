...
## Interpretation of Results {#sec:interpretation-of-results}
...
### Selective Low-SNR Advantage of Neural Relays (H1: Partially Confirmed) {#sec:selective-low-snr-advantage-of-neural-relays-h1-partially-confirmed}
...
### Classical Dominance at High SNR (H2: Confirmed) {#sec:classical-dominance-at-high-snr-h2-confirmed}
...
### Channel Robustness {#sec:channel-robustness}
...
### MIMO Equalization Hierarchy (H6: Confirmed) {#sec:mimo-equalization-hierarchy-h6-confirmed}
...
## The "Less is More" Principle (H3: Confirmed) {#sec:the-less-is-more-principle-h3-confirmed}
...
### Information-Theoretic Perspective {#sec:information-theoretic-perspective}
...
### Bias-Variance Analysis {#sec:bias-variance-analysis}
...
## State Space vs. Attention for Signal Processing {#sec:state-space-vs.-attention-for-signal-processing}
...
### Context-Length Benchmark: Validating the Crossover Hypothesis {#sec:context-length-benchmark-validating-the-crossover-hypothesis}
...
## Practical Deployment Recommendations {#sec:practical-deployment-recommendations}
