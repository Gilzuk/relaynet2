...
def plot_results(summary, lat_mlp, lat_vit):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(_OUT_FIG, 'e6_mlp_qpsk_vs_viterbi.png'), dpi=150, bbox_inches='tight')
    print("\n  Saved: /tmp/e6_mlp_qpsk_vs_viterbi.png")

    np.save(os.path.join(_OUT_NPY, 'e6_mlp_qpsk_vs_viterbi_results.npy'),
