...
**§5.2 (AWGN calibration) is untouched and must stay** ~~[SUPERSEDED 2026-08-22: §5.2 was removed entirely in the 151→120 page reduction. The simulator is now calibrated on the canonical channel itself, against the closed-form two-hop DF composition. Do not restore §5.2 on the strength of this line.]~~ — the closed forms the simulator validates against are AWGN expressions. What went away is any *relay* measured on AWGN in the canonical chapter. Appendix E's AK#4 response was updated accordingly; it had cited the companion table as part of AWGN's bounded role, so leaving it would have dangled a `\ref` and misdescribed the design.
