...
| MMSE complexity-matched baseline | `mmse_equalizer.py` | `mmse_equalizer.json` | `b1ea325` 2026-08-31 | `tbl:mmse-baseline`, `prose: MMSE monotonicity by tap count` | ok |
| MMSE complexity-matched baseline | `mmse_equalizer.py` | `mmse_equalizer_detail.json` | **uncommitted** | `tbl:mmse-baseline`, `prose: MMSE monotonicity by tap count` | **DATA UNCOMMITTED** |
