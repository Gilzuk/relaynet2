...
\caption{The four layers of the argument. Each removes one assumption from the layer above; the relay comparison is otherwise identical. BER figures are the representative operating points cited in the sections named.}\label{tbl:layers}\tabularnewline
\toprule\noalign{}
