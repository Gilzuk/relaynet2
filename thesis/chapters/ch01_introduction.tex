...
function}. BPSK appears only in the unknown-channel study of
Chapter~\ref{sec:unknown-channels}, where the one-dimensional alphabet keeps the
trellis small enough for an exact Viterbi benchmark. A dedicated unknown-channel contribution (Chapter~\ref{sec:unknown-channels}) is included;
