...
}\end{equation} \par{\small\textit{Source: \cite{CoverGamal1979RelayChannel}, Thm. 1], [4, Ch. 16]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}, Eq. 9], [21, Ch. 14]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}1, Eq. 2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}1, Eq. 3]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}4, Eq. 1]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}3, Eq. 3]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}3, Eq. 2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}5, Eq. 1]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}5, Eq. 2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}5, Sec. 3.5]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}7, Eq. 1]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}7, Eq. 2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}7, Eq. 3]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}6, Eq. 4]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}8, Eq. 2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}8, Eq. 3]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Telatar1999MIMO}, Eq. 1], [27, Eq. 1]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}9, Ch. 7.2]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}9, Ch. 7.2], [29]}}
...
}\end{equation} \par{\small\textit{Source: \cite{Laneman2004CooperativeDiversity}9, Ch. 7.2], [28]}}
