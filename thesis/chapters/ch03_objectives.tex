...
\tightlist
\item
  \textbf{Modulation:} QPSK for every relay comparison; 16-QAM enters only as a modulation-and-coding rung in the link-adaptation study. Higher-order constellations as a relay design question, and the joint 2D $N$-class formulation they require, are deferred to future work.
\item
