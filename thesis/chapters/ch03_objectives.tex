...
The following limitations define the scope of this study, confined throughout to the canonical setup (SISO, Rayleigh fast fading, complex baseband, QPSK, uncoded):

\begin{itemize}
\tightlist
\item
  \textbf{Modulation:} QPSK throughout. Higher-order constellations, and the joint 2D $N$-class relay formulation they require, are deferred to future work.
\item
...
These delimitations isolate the relay processing function from protocol- and system-level confounds.
