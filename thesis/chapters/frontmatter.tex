...
The results delineate operating regimes: classical processing where the model matches the channel, the learned relay where it has unmodeled structure, is poorly estimated, or is missing per block.
