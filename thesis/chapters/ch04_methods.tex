...
with hard-decision demodulation \(\hat{b} = \mathbb{1}[\hat{x} < 0]\) at the destination. The QPSK and 16-QAM extensions are defined section~\ref{sec:modulation-schemes} and evaluated in Chapter~\ref{sec:extensions}; further constellations are future work.
