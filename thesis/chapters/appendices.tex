...
\subsection{The Withdrawn QPSK Benchmark and the Reversal That Did Not Survive}\label{sec:withdrawn-qpsk-benchmark}

This section records, in full, a result reported in an earlier version of Section~\ref{sec:qpsk-unknown-channel} and subsequently withdrawn. It is kept because the withdrawal is part of the evidence: the benchmark that produced the result looked plausible and was model-mismatched, and the two measurements that settled the question are the same ones the chapter now relies on.
