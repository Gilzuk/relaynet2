...
\textbf{Soft read-out helps the learned relay everywhere.} At every SNR the posterior mean beats the argmax, on identical weights: $0.4343$ against $0.4443$ at 0~dB, $0.0878$ against $0.1008$ at 8~dB, $0.000912$ against $0.001056$ at 20~dB. The gain is largest exactly where the mechanism predicts, since a relay that reports its uncertainty gives the destination's decoder more to work with than one that reports a confident guess. It is enough to change a verdict: at 16~dB the hard MLP significantly \emph{loses} to block-DF (19 of 99 paired trials) while the soft MLP significantly \emph{beats} it (100 of 100), and at 20~dB the soft relay comes within $0.00023$ of the oracle floor that no relay of any kind can pass.
