...
\REV{``inverted-U'' \(\to\) ``overfitting at excess capacity'', consistent with the retitled H3 in Chapter~\ref{sec:research-objectives} (BER is U-shaped in model size; equivalently, accuracy is inverted-U).}
