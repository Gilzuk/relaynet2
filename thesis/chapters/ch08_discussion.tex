...
Taken together, these measurements support the weaker claim and leave the overfitting hypothesis unsupported --- now on the basis of a sweep designed to detect it, rather than for want of evidence. The practical statement that survives is narrower than ``less is more'' and more actionable: relay complexity should be matched to channel memory, and on a memoryless channel the matched complexity is very small indeed.
