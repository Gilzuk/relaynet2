...
def plot_results(summary):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(_OUT_FIG, 'e6_mlp_vs_viterbi_qpsk_comparison.png'), dpi=150, bbox_inches='tight')
    print("\n  Saved: /tmp/e6_mlp_vs_viterbi_qpsk_comparison.png")
    np.save(os.path.join(_OUT_NPY, 'e6_mlp_vs_viterbi_qpsk_results.npy'), {'snrs': SNRS, 'summary': summary}, allow_pickle=True)
