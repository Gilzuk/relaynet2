...
\begin{itemize} 
 \item \textbf{Topology:} SISO (both hops) 
    ...
    \end{itemize} 
\item \textbf{Evaluation:} 5 trials $\times$ 50{,}000 bits per SNR point, SNR range 0--20 dB
\end{itemize}
