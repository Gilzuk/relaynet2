...
\REV{Fix applied: the $30$--$90\times$ wall-clock figure now carries the implementation caveat (vectorized NumPy matmul vs.\ interpreted Python trellis loop; a C/SIMD Viterbi would narrow the gap), so the implementation-independent $M^{L}$-vs.-constant scaling argument carries the conclusion.}
