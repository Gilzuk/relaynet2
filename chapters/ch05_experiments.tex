...
Prior to evaluating relay strategies, we first verify that the simulation framework produces bit error rate (BER) results consistent with theoretical predictions. The channel validation plots presented in Section~\ref{sec:channel-model-validation} confirm the following:

\begin{itemize}
  \item \textbf{AWGN channel:} Theoretical and simulated BER curves match exactly. The classical $Q(\sqrt{\gamma})$ expression (see the noise-convention note in Section~\ref{sec:noise_convention}), as well as its two-hop extensions—including the effective SNR for amplify-and-forward (AF) relaying and the error-composition model for decode-and-forward (DF)—are validated within tight 95\% confidence intervals across all SNR points (Figure~\ref{fig:awgn_validation}).

  \item \textbf{Rayleigh fading:} The simulation confirms the high-SNR asymptotic behavior $\mathrm{BER} \sim \frac{1}{4\bar{\gamma}}$. The simulated BER closely follows the analytical curve
  \[
    \frac{1}{2}\!\left(1 - \sqrt{\frac{\gamma}{1+\gamma}}\right),
  \]
  as shown in Figure~\ref{fig:rayleigh_validation}.

  \item \textbf{Rician fading ($K=3$):} The BER performance lies between the AWGN and Rayleigh extremes, in agreement with predictions obtained from the moment-generating function (MGF) formulation. The presence of a line-of-sight (LOS) component reduces the fading penalty by approximately 8--10~dB relative to Rayleigh fading at $\mathrm{BER}=10^{-2}$ (Figure~\ref{fig:rician_validation}).

  \item \textbf{Fading statistics:} Empirical probability density functions (PDFs) confirm the assumed channel distributions. Rayleigh fading exhibits the broadest spread and the highest probability of deep fades, while increasing the Rician $K$-factor progressively concentrates the distribution around the LOS amplitude (Figure~\ref{fig}).

  \item \textbf{MIMO equalization:} The ordering of linear and nonlinear equalizers is consistently observed as
  \[
    \text{ZF} < \text{MMSE} < \text{SIC}
  \]
...
$2\times2$ MIMO with ZF equalization
& 9.10E-2 & 9.15E-2
& 2.33E-2 & 2.35E-2
& 7.58E-3 & 7.55E-3 \\

$2\times2$ MIMO with MMSE equalization
& -- & 6.82E-2
& -- & 1.68E-2
& -- & 4.12E-3 \\

$2\times2$ MIMO with SIC detection
& -- & 5.50E-2
& -- & 1.20E-2
& -- & 3.05E-3 \\
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/channel_theoretical_rician.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/channel_fading_pdf.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/mimo_equalizer_comparison.png}}
\caption{2x2 MIMO Rayleigh : single-hop BER with ZF, MMSE, and SIC equalization. Theoretical approximations (solid/dashed lines) overlaid with Monte Carlo simulation (markers with 95\% CI). MMSE provides \textasciitilde1--2 dB gain over ZF; SIC provides an additional \textasciitilde0.5--1 dB gain.}
\end{figure}

\begin{figure}[H]
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/channel_analysis_summary.png}}
\caption{Consolidated 2x3 grid of all channel model validations. Top row: (a) AWGN, (b) Rayleigh, (c) Rician K=3 : theory (blue) vs.~simulation (red). Bottom row: (d) all SISO channels compared, (e) fading PDFs, (f) MIMO equalizer comparison.}
\end{figure}

\begin{figure}[H]
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/channel_comparison_all.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/rician_comparison_ci.png}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}@{}}
\caption{BER comparison on 2x2 MIMO Rayleigh channel with ZF equalization.}\label{tbl:table4}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}@{}}
\caption{BER comparison on 2x2 MIMO Rayleigh channel with MMSE equalization.}\label{tbl:table5}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1000}}@{}}
\caption{BER comparison on 2x2 MIMO Rayleigh channel with MMSE-SIC equalization.}\label{tbl:table6}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/mimo_2x2_comparison_ci.png}}
\caption{2x2 MIMO with ZF equalization : BER vs.~SNR for all nine relay strategies with 95\% CI.}\label{fig:fig12}
\end{figure}

\begin{figure}[H]
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/mimo_2x2_mmse_comparison_ci.png}}
\caption{2x2 MIMO with MMSE equalization : BER vs.~SNR for all nine relay strategies with 95\% CI.}\label{fig:fig13}
\end{figure}

\begin{figure}[H]
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/mimo_2x2_sic_comparison_ci.png}}
\caption{2x2 MIMO with MMSE-SIC equalization : BER vs.~SNR for all nine relay strategies with 95\% CI.}\label{fig:fig14}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}@{}}
\caption{Normalized 3K BER results : 2x2 MIMO ZF.}\label{tbl:table10}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}@{}}
\caption{Normalized 3K BER results : 2x2 MIMO MMSE.}\label{tbl:table11}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1111}}@{}}
\caption{Normalized 3K BER results : 2x2 MIMO SIC.}\label{tbl:table12}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
SNR (dB)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1667}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1667}}@{}}
\caption{Model complexity and timing comparison (experiment-specific training settings; Monte Carlo evaluation over 11 SNR points x 10 trials x 10,000 bits). All inference uses batched window extraction and a single forward pass per signal block.}\label{tbl:table13}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/normalized_3k_all_channels.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/normalized_3k_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/normalized_3k_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/normalized_3k_rician_k3.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/master_ber_comparison.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/bpsk_rayleigh_ci.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/qpsk_awgn_ci.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/qpsk_rayleigh_ci.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/qam16__awgn_ci.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/qam16__rayleigh_ci.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/modulation/combined_modulation_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/qam16_activation/qam16_activation_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/qam16_activation/qam16_activation_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/bpsk_activation_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/bpsk_activation_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[height=0.8\textheight,keepaspectratio]{results/activation_comparison/qpsk_activation_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/qpsk_activation_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/qam16_activation_awgn.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/qam16_activation_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/activation_comparison/various_activation_functions.png}}
...
Determine whether CSI injection universally improves relay performance & CSI injection is modulation-dependent: beneficial for PSK16, detrimental for QAM16 & \textbf{Achieved} : unexpected finding that refutes the Section \ref{sec:higher-order-modulation-scalability-constellation-aware-training} hypothesis of universal CSI benefit \\
Evaluate the role of input LayerNorm across architectures & LayerNorm consistently helps QAM16 (all top-3 use it) but is neutral-to-unnecessary for PSK16 & \textbf{Achieved} : extends Section \ref{sec:higher-order-modulation-scalability-constellation-aware-training} finding to multi-model, multi-constellation setting \\
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/csi_experiment_qam16_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/top3_qam16_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/csi_experiment_psk16_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/top3_psk16_rayleigh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/training_Mamba2_LN_scaled_tanh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/training_Mamba_CSI_tanh.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/csi/training_Transformer_CSI_sigmoid.png}}
...
CGAN & 0.00811 & : & : \\
Hybrid & : & : & : \\
Transformer & 0.00810 & \textbf{0.00001} & 810x \\
Mamba S6 & 0.00810 & \textbf{0.00009} & 90x \\
Mamba-2 SSD & 0.00811 & \textbf{0.00197} & 4.1x \\
AF & 0.00063 & : & : \\
DF & 0.00000 & : & : \\
\end{longtable}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/all_relays_16class/ber_all_relays_16class.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/all_relays_16class/grouped_bar_16class.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/all_relays_16class/heatmap_all_relays_16class.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/all_relays_16class/top3_16class.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/e2e/e2e_ber_comparison.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/e2e/e2e_constellation.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/e2e/e2e_training_loss.png}}
...
\centering
\centering
\pandocbounded{\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{results/e2e/e2e_relay_comparison.png}}
