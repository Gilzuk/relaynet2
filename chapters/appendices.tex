...
\subsection{Testing} 126 automated tests (pytest) cover all channels,modulation (BPSK, QPSK, 16-QAM), relay strategies, simulation, statistics, and modulation-comparison modules with 100\% pass rate.
