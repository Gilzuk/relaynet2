...
\captionsetup[table]{position=below}git config --global user.name "Your Name"
...
\include{chapters/ch00_cover_page}
...
\include{chapters/ch05_experiment_refactored}
\include{chapters/ch06_discussion}
\include{chapters/ch07_equation_ref}
\include{chapters/ch08_references}
\include{chapters/ch09_appendices}

\backmatter
\include{chapters/ch10_hebrew_abstract}
